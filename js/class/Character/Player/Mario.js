...
// util
import { playerKeyTable } from "../../../utils/index.js";
/**
 * 마리오 클래스
 *
...
export default class Mario extends Player {
  ...
  acceleration() {
    ...
    const startTime =
      ((_a = keys.ArrowRight) === null || _a === void 0
        ? void 0
        : _a.startTime) ||
      ((_b = keys.ArrowLeft) === null || _b === void 0
        ? void 0
        : _b.startTime) ||
      Date.now();
    // 가속 처리
    ...
    if (
      ((keys === null || keys === void 0 ? void 0 : keys.ArrowRight) ||
        (keys === null || keys === void 0 ? void 0 : keys.ArrowLeft)) &&
      this.isRunning()
    ) {
      this.toggleIsNext();
    }
